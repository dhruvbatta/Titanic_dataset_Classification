...
# -*- coding: utf-8 -*-
"""
Created on Tue May 14 13:45:39 2019

@author: dhruv
"""
"""
predicting if a passenger survive Titanic or not. 
...
trees = RandomForestClassifier(n_estimators = 150, criterion = 'entropy', random_state = 0)
...
output.head()
output.to_csv('titanic_predictions00.csv', index = False)
